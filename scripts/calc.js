...
const numpad_buttons = ['Numpad0','Numpad1', 'Numpad2', 'Numpad3', 'Numpad4', 'Numpad5', 'Numpad6', 'Numpad7', 'Numpad8', 'Numpad9', 'NumpadAdd', 'NumpadDivide', 'NumpadMultiply', 'NumpadSubtract', 'NumpadDecimal', 'NumpadEnter']
const data_keys = ['Backspace', 'Slash','Delete', 'Digit0','Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9']

window.addEventListener(
    "keydown",
    (event) => {
      let key = null
      if (numpad_buttons.includes(event.code) ){
        key = document.querySelector(`button[numpad-key='${event.code}']`);
      }
      else if (data_keys.includes(event.code) ){
        key = document.querySelector(`button[data-key='${event.code}']`);
      }
      if (key != null){
        key.click();
      }
