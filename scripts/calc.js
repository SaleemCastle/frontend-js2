...
const numpad_keys = ['Numpad0','Numpad1', 'Numpad2', 'Numpad3', 'Numpad4', 'Numpad5', 'Numpad6', 'Numpad7', 'Numpad8', 'Numpad9', 'NumpadAdd', 'NumpadDivide', 'NumpadMultiply', 'NumpadSubtract', 'NumpadDecimal', 'NumpadEnter']
const data_keys = ['Period', 'Enter', 'Backspace', 'Slash','Delete', 'Digit0','Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9']
